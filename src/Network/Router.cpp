...
httpserver::Router::Router(std::unique_ptr<IRequestParser> requestParser): requestParser(std::move(requestParser)){}

void httpserver::Router::registerRoute(std::string url, Method method,httpserver::IHandler handler) {
